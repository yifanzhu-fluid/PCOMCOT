      ...
      subroutine  okada1985(x,y,u1,u2,u3,depth,xlength,xwidth,
     &                      slip,strike,dip,rake,x0,y0)
      implicit real*8 (a-h,o-z)
      data alp,disl3,zero,PI/0.667,0.,0.,3.141593/
      ...
      call srectf(alp,xr,yr,depth,-xlength/2,xlength/2,
     &    -xwidth/2,xwidth/2,sd,cd,disl1,disl2,disl3,u1,u2,u3,u11,u12,
     &    u21,u22,u31,u32)
      ...
      subroutine  okada1985real(x,y,u1,u2,u3,depth,xlength,xwidth,
     &                      slip,strike,dip,rake,x0,y0)
      implicit real*8 (a-h,o-z)
      data alp,disl3,zero,PI/0.667,0.,0.,3.141593/
      real*4 x,y,u1,u2,u3,depth,xlength
      real*4 xwidth,slip,strike,dip,rake,x0,y0
      ...
      call srectf(alp,xr,yr,DBLE(depth),-DBLE(xlength)/2,
     & DBLE(xlength)/2,-DBLE(xwidth)/2,DBLE(xwidth)/2,
     & sd,cd,disl1,disl2,disl3,
     & w1,w2,w3,u11,u12,u21,u22,u31,u32)
...
Cf2py   intent(in) x,y,n,depth,dip,rake,slip,xlength,xwidth
      implicit real*8 (a-h,o-z)
      real*8 x(n),y(n),z(n),zero
      data alp,disl3,zero/0.5,0.,0./
...
c         dx = x(i)-x0
c         dy = y(i)-y0
c         xr = dx*sin(strike) + dy*cos(strike)
c         yr = dy*sin(strike) - dx*cos(strike)
         call srectf(alp,x(i)*.001,y(i)*.001,depth*.001,zero,xlength,
     &        zero,xwidth,sd,cd,disl1,disl2,disl3,u1,u2,u3,u11,u12,
     &        u21,u22,u31,u32)
         z(i) = u3
 100  continue
      return
