subroutine okada1985(x,y,u1,u2,u3,depth,xlength,xwidth,slip,strike,dip,rake,x0,y0)

implicit NONE
real*8  ::  x, y, u1, u2, u3, depth, xlength, xwidth, slip, strike, dip, rake, x0, y0
...
SUBROUTINE  SPOINT(ALP,X,Y,DEP,SD,CD,POT1,POT2,POT3,U1,U2,U3,U11,U12,U21,U22,U31,U32)
!*******************************************************************************
!*****                                                                     *****
...
!******************************************************************************* 
IMPLICIT NONE
REAL*8  ::  ALP, X, Y, DEP, SD, CD, POT1, POT2, POT3, U1, U2, U3, U11, U12, U21, U22, U31, U32
REAL*8  ::  D, P, Q, S, X2, Y2, XY, D2, R2, R, R3, R5, QR, XR, YR, XYR, DR, RD, R12, R32, R33, R53, R54
REAL*8  ::  A1, A2, A3, A4, A5, B1, B2, B3, B4, C1, C2, C3
REAL*8  ::  UN, QRX, FX, SDCD, QRP, FS, SDSD, QRQ, FQ
REAL*8, PARAMETER   ::  F0 = 0.0, F1 = 1.0, F2 = 2.0, F3 = 3.0, F4 = 4.0, F5 = 5.0, F8 = 8.0, F9 = 9.0
REAL*8, PARAMETER   ::  PI2 = 6.283185
...
SUBROUTINE  SRECTF(ALP,X,Y,DEP,AL1,AL2,AW1,AW2,SD,CD,DISL1,DISL2,DISL3,U1,U2,U3,U11,U12,U21,U22,U31,U32)
!*******************************************************************************
!*****                                                                     *****
!*****    SURFACE DISPLACEMENT,STRAIN,TILT                                 *****
...
SUBROUTINE  SRECTG(ALP,XI,ET,Q,SD,CD,DISL1,DISL2,DISL3,U1,U2,U3,U11,U12,U21,U22,U31,U32)
!*******************************************************************************
!*****                                                                     *****
